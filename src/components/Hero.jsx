...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col md:flex-row items-center gap-10 py-20 md:pb-40">
      ...
      <img src={heroImg} alt="Hero image" className="w-full h-72 object-cover md:w-[420px] md:h-[400px] rounded-xl" />
    </section>
  );
}
